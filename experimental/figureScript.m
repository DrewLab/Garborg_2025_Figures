...
plotFluorescenceChange_FS(combinedMovementDataBrain_221207_010)

%% extended data figure 2e

plotStaticMicrospheres_FS
...
plotMotionTrackingBrainOnly_FS(combinedMovementData_210218_006,'Extended Data Figure 4b')
...
plotMotionTrackingBrainAndSkullResp_FS(combinedMovementDataBrain_240611_001,combinedMovementDataSkull_240611_001,'Extended Data Figure 5d_1');
...
%% supplementary figure 9a-d

plotSqueezeRespHist_FS(STATimeData,STADispData,RTATimeData,RTADispData)

%% movie 1

plotMotionTrackingBrainOnly_FS(combinedMovementData_210218_006,'Movie 1')
...
plotMotionTrackingBrainAndSkullResp_FS(combinedMovementDataBrain_240611_001,combinedMovementDataSkull_240611_001,'Movie 5')

%% movie 7

plotMotionTrackingBrainAndSkullSqueeze_FS(combinedMovementDataBrain_240612_020,combinedMovementDataSkull_240612_020,'Movie 7_1')
plotMotionTracking2P2LPCASqueeze_FS(combinedMovementDataBrain_240612_020,combinedMovementDataSkull_240612_020,'Movie 7_2')
...
x1 = subplot(3,1,1);
plot((1:size(movementData.targetPosition,1))*movementData.secondsPerFrame,movementData.targetPosition(:,1),'Color',[.1 .62 .47])
hold on;
...
x2 = subplot(3,1,2);
plot((1:size(movementData.targetPosition,1))*movementData.secondsPerFrame,-1*movementData.targetPosition(:,2),'Color',[.46 .44 .7])
hold on;
...
targetPositionInSkull = combineBrainSkullMovement_FS(movementData,stationaryData);
motionVec = pcaMotionAnalysis_FS(targetPositionInSkull);
h(2) = figure('Color','White','Name','Movie 3_2','NumberTitle','off');
s = scatter(targetPositionInSkull(:,1),targetPositionInSkull(:,2),10,'g','filled');
s.MarkerFaceAlpha = .1;
hold on
drawArrow_FS([0;0],[motionVec(1);motionVec(2)]);
...
brainStdX = {[],[],[],[],[]};
brainStdY = {[],[],[],[],[]};
h(3) = figure('Color','White','Name','Extended Data Figure 3b','NumberTitle','off');
hold on
for n = 1:size(moveDataMat,1)
    if strcmp(moveDataMat{n,3},'21a')
        arrowColor = 'r';
...
plot(movementData.secondsPerFrame*(-maxlag:maxlag),xc_1,'Color',[.1 .62 .47])
hold on
plot(movementData.secondsPerFrame*(-maxlag:maxlag),xc_2,'Color',[.46 .44 .7])
hold off
...
subplot(4,1,1)
plot([1:size(targetPositionInSkull,1)]*movementData.secondsPerFrame,targetPositionInSkull(:,1),'Color',[.1 .62 .47])
...
subplot(4,1,2)
plot([1:size(targetPositionInSkull,1)]*movementData.secondsPerFrame,targetPositionInSkull(:,2),'Color',[.46 .44 .7])
xlabel('Time (s)')
ylabel('Brain Shift (\mum)')
grid on
axis([0 600 -2 6])
...
targetPositionInSkull = combineBrainSkullMovement_FS(movementData,stationaryData);
movementData.secondsPerFrame = movementData.secondsPerFrame/2;
h(6) = figure('Color','White','Name','Movie 2','NumberTitle','off');
subplot(5,1,1)
plot([1:size(targetPositionInSkull,1)]*movementData.secondsPerFrame,targetPositionInSkull(:,1),'Color',[.1 .62 .47])
% title(['Figure 3c' 10 '\fontsize{20pt}\bf{Position of Brain in Skull}'])
xlabel('Time (s)')
...
ylabel('Treadmill Velocity (m/s)')
subplot(5,1,5)
plot(movementData.thermoData(:,1),movementData.thermoData(:,2),'Color',[.65 .46 .11])
axis([200 220 -.5 .5])
xlabel('Time (s)')
...
% stationaryData.targetPosition(:,2) = stationaryData.targetPosition(:,2)-mean(stationaryData.targetPosition(2480:2530,2));
% movementData.secondsPerFrame = movementData.secondsPerFrame/2;
h(6) = figure('Color','White','Name','Movie 4','NumberTitle','off');
subplot(3,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
hold on
plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
% stationaryData.targetPosition(:,2) = stationaryData.targetPosition(:,2)-mean(stationaryData.targetPosition(2480:2530,2));
movementData.secondsPerFrame = movementData.secondsPerFrame/2;
h(6) = figure('Color','White','Name','Movie 3_1','NumberTitle','off');
subplot(4,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
hold on
plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
h(9) = figure('Color','White','Name','Figure 2e-f','NumberTitle','off');
subplot(2,2,1)
...
for n = 1:size(motionEventsLocationsX,1)
    plot(timeVecX,motionEventsLocationsX(n,:),'Color',[.1 .62 .47 0.1])
end
...
for n = 1:size(motionEventsLocationsY,1)
    plot(timeVecY,-1*motionEventsLocationsY(n,:),'Color',[.46 .44 .7 0.1])
end
...
for n = 1:size(stopMotionEventsLocationsX,1)
    plot(timeVecX,stopMotionEventsLocationsX(n,:),'Color',[.1 .62 .47 0.1])
end
hold off
text(3,-3,'Medial','VerticalAlignment','bottom','HorizontalAlignment','left','FontSize',15);
text(3,3,'Lateral','VerticalAlignment','top','HorizontalAlignment','left','FontSize',15);
...
for n = 1:size(stopMotionEventsLocationsY,1)
    plot(timeVecY,-1*stopMotionEventsLocationsY(n,:),'Color',[.46 .44 .7 0.1])
end
hold off
text(3,-3,'Caudal','VerticalAlignment','bottom','HorizontalAlignment','left','FontSize',15);
text(3,3,'Rostral','VerticalAlignment','top','HorizontalAlignment','left','FontSize',15);
...
h(9) = figure('Color','White','Name','Figure 3g-h','NumberTitle','off');
subplot(2,2,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
f = fill([3 0 0 3],[2.9 2.9 -2.9 -2.9],[.9 .9 .9],'Linestyle','none','FaceAlpha',0.5);
hold on
...
h(10) = figure('Color','White','Name','Supplementary Figure 4a','NumberTitle','off');
subplot(1,2,1)
histogram(LTATimeData.timeToThreshX,LTATimeData.binEdgesTime,'FaceColor',[.9 .67 .01],'FaceAlpha',0.5);
hold on
histogram(ETATimeData.timeToThreshX,ETATimeData.binEdgesTime,'FaceColor',[.85 .37 .01],'FaceAlpha',0.5);
hold off
...
xlim([-2 3])
ylim([0 60])
text(-2,55,'Locomotion Trigger','Color',[.9 .67 .01],'FontSize',12)
text(-2,50,'EMG Trigger','Color',[.85 .37 .01],'FontSize',12)
...
subplot(1,2,2)
plot(LTATimeData.X_pdfXVals,LTATimeData.X_pdfYVals,'Color',[.9 .67 .01],'LineWidth',2)
hold on
plot(ETATimeData.X_pdfXVals,ETATimeData.X_pdfYVals,'Color',[.85 .37 .01],'LineWidth',2)
% [pdfXVals,pdfYVals] = findKernelPDF(timeToThreshX,binEdgesTime);
% plot(pdfXVals,pdfYVals*25,'r','LineWidth',2)
title(['Time for brain to displace laterally 0.75 micrometers following trigger'])
xlabel('Time (s)')
...
mu = mean(LTATimeData.timeToThreshX);
sig = std(LTATimeData.timeToThreshX);
plot([mu mu],[0 60],'Color',[.9 .67 .01],'LineWidth',2);
plot([mu+sig mu+sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
text(-2,15,['displacement thresh = 0.75, n = ' num2str(length(LTATimeData.timeToThreshX)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.9 .67 .01])
mu = mean(ETATimeData.timeToThreshX);
sig = std(ETATimeData.timeToThreshX);
plot([mu mu],[0 60],'Color',[.85 .37 .01],'LineWidth',2);
plot([mu+sig mu+sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
text(-2,10,['displacement thresh = 0.75, n = ' num2str(length(ETATimeData.timeToThreshX)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.85 .37 .01])
hold off
% ETATimeData.timeToThreshX = timeToThreshX;
% ETATimeData.binEdgesTime = binEdgesTime;
% ETATimeData.X_pdfXVals = pdfXVals;
...
h(10) = figure('Color','White','Name','Supplementary Figure 4b','NumberTitle','off');
subplot(1,2,1)
histogram(LTATimeData.timeToThreshY,LTATimeData.binEdgesTime,'FaceColor',[.9 .67 .01],'FaceAlpha',0.5);
hold on
histogram(ETATimeData.timeToThreshY,ETATimeData.binEdgesTime,'FaceColor',[.85 .37 .01],'FaceAlpha',0.5);
hold off
% [pdfXVals,pdfYVals] = findKernelPDF(LTATimeData.timeToThreshX,LTATimeData.binEdgesTime);
% plot(LTATimeData.pdfXVals,LTATimeData.pdfYVals,'r','LineWidth',2)
...
subplot(1,2,2)
plot(LTATimeData.Y_pdfXVals,LTATimeData.Y_pdfYVals,'Color',[.9 .67 .01],'LineWidth',2)
hold on
plot(ETATimeData.Y_pdfXVals,ETATimeData.Y_pdfYVals,'Color',[.85 .37 .01],'LineWidth',2)
% [pdfXVals,pdfYVals] = findKernelPDF(timeToThreshX,binEdgesTime);
% plot(pdfXVals,pdfYVals*25,'r','LineWidth',2)
title(['Time for brain to displace rostrally 0.75 micrometers following trigger'])
xlabel('Time (s)')
...
plot([mu+sig mu+sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
text(-2,15,['displacement thresh = 0.75, n = ' num2str(length(LTATimeData.timeToThreshY)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.9 .67 .01])
mu = mean(ETATimeData.timeToThreshY);
sig = std(ETATimeData.timeToThreshY);
plot([mu mu],[0 60],'Color',[.85 .37 .01],'LineWidth',2);
plot([mu+sig mu+sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
text(-2,10,['displacement thresh = 0.75, n = ' num2str(length(ETATimeData.timeToThreshY)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.85 .37 .01])
hold off
% ETATimeData.timeToThreshX = timeToThreshX;
% ETATimeData.binEdgesTime = binEdgesTime;
% ETATimeData.X_pdfXVals = pdfXVals;
...
h(50) = figure('Color','White','Name','Supplementary Figure 4c','NumberTitle','off');
subplot(1,2,1)
histogram(LTADispData.dispTimeThreshX,LTADispData.binEdgesDisp,'FaceColor',[.9 .67 .01],'FaceAlpha',0.5);
hold on
histogram(ETADispData.dispTimeThreshX,ETADispData.binEdgesDisp,'FaceColor',[.85 .37 .01],'FaceAlpha',0.5);
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshX,binEdgesDisp);
% plot(pdfXVals,pdfYVals*40,'r','LineWidth',2)
...
xlim([-4 4])
ylim([0 60])
text(-4,55,'Locomotion Trigger','Color',[.9 .67 .01],'FontSize',12)
text(-4,50,'EMG Trigger','Color',[.85 .37 .01],'FontSize',12)
% mu = mean(dispTimeThreshX);
% sig = std(dispTimeThreshX);
% plot([mu mu],[0 60],'k','LineWidth',2);
% plot([mu+sig mu+sig],[0 60],'k--','LineWidth',2);
...
subplot(1,2,2)
plot(LTADispData.X_pdfXVals,LTADispData.X_pdfYVals,'Color',[.9 .67 .01],'LineWidth',2)
hold on
plot(ETADispData.X_pdfXVals,ETADispData.X_pdfYVals,'Color',[.85 .37 .01],'LineWidth',2)
% [pdfXVals,pdfYVals] = findKernelPDF(timeToThreshX,binEdgesTime);
% plot(pdfXVals,pdfYVals*25,'r','LineWidth',2)
title('Lateral displacement of brain after 1.5 seconds following trigger')
xlabel('Displacement (\mum)')
...
plot([mu+sig mu+sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
text(-2,15,['displacement thresh = 0.75, n = ' num2str(length(LTADispData.dispTimeThreshX)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.9 .67 .01])
mu = mean(ETADispData.dispTimeThreshX);
sig = std(ETADispData.dispTimeThreshX);
plot([mu mu],[0 60],'Color',[.85 .37 .01],'LineWidth',2);
plot([mu+sig mu+sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
text(-2,10,['displacement thresh = 0.75, n = ' num2str(length(ETADispData.dispTimeThreshX)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.85 .37 .01])
hold off

h(50) = figure('Color','White','Name','Supplementary Figure 4d','NumberTitle','off');
subplot(1,2,1)
histogram(LTADispData.dispTimeThreshY,LTADispData.binEdgesDisp,'FaceColor',[.9 .67 .01],'FaceAlpha',0.5);
hold on
histogram(ETADispData.dispTimeThreshY,ETADispData.binEdgesDisp,'FaceColor',[.85 .37 .01],'FaceAlpha',0.5);
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshX,binEdgesDisp);
% plot(pdfXVals,pdfYVals*40,'r','LineWidth',2)
...
subplot(1,2,2)
plot(LTADispData.Y_pdfXVals,LTADispData.Y_pdfYVals,'Color',[.9 .67 .01],'LineWidth',2)
hold on
plot(ETADispData.Y_pdfXVals,ETADispData.Y_pdfYVals,'Color',[.85 .37 .01],'LineWidth',2)
% [pdfXVals,pdfYVals] = findKernelPDF(timeToThreshX,binEdgesTime);
% plot(pdfXVals,pdfYVals*25,'r','LineWidth',2)
title('Rostral displacement of brain after 1.5 seconds following trigger')
xlabel('Displacement (\mum)')
...
plot([mu+sig mu+sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.9 .67 .01],'LineStyle','--','LineWidth',2);
text(-2,15,['displacement thresh = 0.75, n = ' num2str(length(LTADispData.dispTimeThreshY)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.9 .67 .01])
mu = mean(ETADispData.dispTimeThreshY);
sig = std(ETADispData.dispTimeThreshY);
plot([mu mu],[0 60],'Color',[.85 .37 .01],'LineWidth',2);
plot([mu+sig mu+sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
plot([mu-sig mu-sig],[0 60],'Color',[.85 .37 .01],'LineStyle','--','LineWidth',2);
text(-2,10,['displacement thresh = 0.75, n = ' num2str(length(ETADispData.dispTimeThreshY)) 10 'mean = ' num2str(mu) ', std = ' num2str(sig)],'Color',[.85 .37 .01])
hold off
...
h(9) = figure('Color','White','Name','Extended Data Figure 3c-d','NumberTitle','off');
subplot(2,2,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
f = fill([3 0 0 3],[2.9 2.9 -2.9 -2.9],[.9 .9 .9],'Linestyle','none','FaceAlpha',0.5);
hold on
...
h(9) = figure('Color','White','Name','Extended Data Figure 3e-f','NumberTitle','off');
subplot(2,2,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
f = fill([3 0 0 3],[2.9 2.9 -2.9 -2.9],[.9 .9 .9],'Linestyle','none','FaceAlpha',0.5);
hold on
...
h(9) = figure('Color','White','Name','Supplementary Figure 6b-c','NumberTitle','off');
subplot(2,2,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
f = fill([3 0 0 3],[2.9 2.9 -2.9 -2.9],[.9 .9 .9],'Linestyle','none','FaceAlpha',0.5);
hold on
...
timeThresh = 1.5;
moveThresh = 0.75;
h(10) = figure('Color','White','Name','Supplementary Figure 9a','NumberTitle','off');
subplot(1,2,1)
...
subplot(1,2,2)
histogram(STADispData.dispTimeThreshX,STADispData.binEdgesDisp,'FaceColor',[.1 .62 .47]);
hold on
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshX,binEdgesDisp);
...
h(50) = figure('Color','White','Name','Supplementary Figure 9b','NumberTitle','off');
subplot(1,2,1)
...
subplot(1,2,2)
histogram(STADispData.dispTimeThreshY,STADispData.binEdgesDisp,'FaceColor',[.46 .44 .7]);
hold on
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshY,binEdgesDisp);
...
timeThresh = 0.4;
moveThresh = 0.25;
h(10) = figure('Color','White','Name','Supplementary Figure 9c','NumberTitle','off');
subplot(1,2,1)
...
subplot(1,2,2)
histogram(RTADispData.dispTimeThreshX,RTADispData.binEdgesDisp,'FaceColor',[.1 .62 .47]);
hold on
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshX,binEdgesDisp);
...
h(50) = figure('Color','White','Name','Supplementary Figure 9d','NumberTitle','off');
subplot(1,2,1)
...
subplot(1,2,2)
histogram(RTADispData.dispTimeThreshY,RTADispData.binEdgesDisp,'FaceColor',[.46 .44 .7]);
hold on
% [pdfXVals,pdfYVals] = findKernelPDF(dispTimeThreshY,binEdgesDisp);
...
h(9) = figure('Color','White','Name','Extended Data Figure 5b','NumberTitle','off');
subplot(2,1,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
plot(timeVecX,meanX,'k')
hold on
...
h(9) = figure('Color','White','Name','Extended Data Figure 5c','NumberTitle','off');
subplot(2,1,1)
maxMeanVal = max(abs([meanX meanY cIntFillPtsX cIntFillPtsY]));
plot(timeVecX,meanX,'k')
hold on
...
% plot([0 0],[0 4],'r')
for n = 1:size(motionEventsLocationsX,1)
    plot(timeVecX,motionEventsLocationsX(n,:),'Color',[.85 .37 .01 0.1])
end
% plot(timeVecX(brainMotionStart),meanX(brainMotionStart),'rx')
hold off
% text(3,-3,'Medial','VerticalAlignment','bottom','HorizontalAlignment','left','FontSize',15);
...
h(1) = figure('Color','White','Name','Supplementary Figure 8b','NumberTitle','off');
subplot(1,2,1)
...
h(3) = figure('Color','White','Name','Supplementary Figure 8c','NumberTitle','off');
subplot(1,2,1)
% micronLengthValWidth = ones(size(widthData,1),1);
% micronLengthValWidth(widthData(:,6) == 1,1) = barSize;
% micronLengthValWidth(widthData(:,6) == -1,1) = holeSize;
...
% plot 3d surface plot of x calibration values across image
h(4) = figure('Color','White','Name','Supplementary Figure 8d-e','NumberTitle','off');
subplot(2,2,1)
% micronLengthValWidth = ones(size(widthData,1),1);
% micronLengthValWidth(widthData(:,6) == 1,1) = barSize;
% micronLengthValWidth(widthData(:,6) == -1,1) = holeSize;
...
% axis([1 W 1 H 0.5 ceil(max(micronLengthValWidth./widthData(:,3)))])
% hold on
plot(x.surfaceCalibFitX,[x.pixelMidpointXWidth,x.pixelMidpointYWidth],x.negativePolarityLengthInMicrons./x.width,'Style','Residuals')
residualList = [];
for n = 1:length(x.pixelMidpointXWidth)
    residualList(n) = abs((x.surfaceCalibFitX(x.pixelMidpointXWidth(n),x.pixelMidpointYWidth(n))) - (x.negativePolarityLengthInMicrons/x.width(n)));
    percentChangeList(n) = (residualList(n)/x.surfaceCalibFitX(x.pixelMidpointXWidth(n),x.pixelMidpointYWidth(n)))*100;
end
text(0,0,-.05,['Mean Residual = ' num2str(mean(residualList)) '\mum/pixel, Mean Percent Change = ' num2str(mean(percentChangeList)) '%'])
xlim([1 W])
ylim([1 H])
zlim([-.1 .05])
% hold off
...
zlabel('\mum/Pixel')
subplot(2,2,3)
histogram(residualList,0:.001:.1,'FaceColor',[.1 .62 .47])
xlabel('Residuals (\mum/pixel)')
ylabel('Counts')
xlim([0 .1])
ylim([0 20])
...
% axis([1 W 1 H 0.5 ceil(max(micronLengthValHeight./heightData(:,3)))])
% hold on
plot(x.surfaceCalibFitY,[x.pixelMidpointXHeight,x.pixelMidpointYHeight],x.negativePolarityLengthInMicrons./x.height,'Style','Residuals')
residualList = [];
percentChangeList = [];
for n = 1:length(x.pixelMidpointXHeight)
    residualList(n) = abs((x.surfaceCalibFitY(x.pixelMidpointXHeight(n),x.pixelMidpointYHeight(n))) - (x.negativePolarityLengthInMicrons/x.height(n)));
    percentChangeList(n) = (residualList(n)/x.surfaceCalibFitY(x.pixelMidpointXHeight(n),x.pixelMidpointYHeight(n)))*100;
end
text(0,0,-.05,['Mean Residual = ' num2str(mean(residualList)) '\mum/pixel, Mean Percent Change = ' num2str(mean(percentChangeList)) '%'])
xlim([1 W])
ylim([1 H])
...
zlabel('\mum/Pixel')
subplot(2,2,4)
histogram(residualList,0:.001:.1,'FaceColor',[.46 .44 .7])
xlabel('Residuals (\mum/pixel)')
ylabel('Counts')
xlim([0 .1])
ylim([0 20])
...
function plotPSF_FS
load('PSFData_FS.mat')
h(1) = figure('Color','White','Name','Extended Data Figure 1c','NumberTitle','off');
subplot(1,2,1)
...
h(1) = figure('Color','White','Name','Extended Data Figure 1f','NumberTitle','off');
subplot(2,1,1)
hold on
for n = 1:numel(fn)
...
h(2) = figure('Color','White','Name','Extended Data Figure 1g','NumberTitle','off');
subplot(3,1,1)
...
h(1) = figure('Color','White','Name','Extended Data Figure 2b','NumberTitle','off');
subplot(2,1,1)
load('fluorescenceData.mat')
brainValues = fluorescenceData.brain;
microsphereValues = fluorescenceData.microsphere;
microsphereDarkValues = fluorescenceData.microsphereDark;
plot(brainValues(:,1),brainValues(:,2),'g')
hold on
plot(microsphereValues(:,1),microsphereValues(:,2),'m')
plot(microsphereDarkValues(:,1),microsphereDarkValues(:,2),'Color',[.07 .4 .39])
xlim([148 398])
...
plot([148 398],[stationaryMicrosphereMean,stationaryMicrosphereMean],'k')
plot([148 398],[stationaryBrainMean,stationaryBrainMean],'k')
plot([148 398],[movementMicrosphereMean,movementMicrosphereMean],'k')
plot([148 398],[movementBrainMean,movementBrainMean],'k')
...
text(148,stationaryMicrosphereMean+250,['\Delta ' num2str(percentChangeMicrospheres*100) '%'],'Color','m')
text(148,stationaryBrainMean+250,['\Delta ' num2str(percentChangeBrain*100) '%'],'Color','g')
...
h(2) = figure('Color','White','Name','Extended Data Figure 2c','NumberTitle','off');
load('PSFData_FS.mat')
plot(PSFData.ZIntensity,PSFData.Z,'k')
hold on
% scatter(PSFData.ZPointsIntensity,PSFData.ZPoints,'kx')
...
text(0.8,2,num2str(1-percentChangeBrain),'Color','g')
text(0.8,3,num2str(1-percentChangeMicrospheres),'Color','m')
[xBrain,yBrain] = polyxpoly([1-percentChangeBrain,1-percentChangeBrain],[-6,6],PSFData.ZIntensity,PSFData.Z);
[xMicrosphere,yMicrosphere] = polyxpoly([1-percentChangeMicrospheres,1-percentChangeMicrospheres],[-6,6],PSFData.ZIntensity,PSFData.Z);
plot([0 xBrain(1)],[yBrain(1) yBrain(1)],'g')
plot([0 xBrain(2)],[yBrain(2) yBrain(2)],'g')
plot([0 xMicrosphere(1)],[yMicrosphere(1) yMicrosphere(1)],'--m')
plot([0 xMicrosphere(2)],[yMicrosphere(2) yMicrosphere(2)],'--m')
text(0.05,-3,num2str(yBrain(1)),'Color','g')
text(0.05,-2,num2str(yMicrosphere(1)),'Color','m')
text(0.05,2,num2str(yBrain(2)),'Color','g')
text(0.05,3,num2str(yMicrosphere(2)),'Color','m')

hold off
ylabel('PSF Depth (\mum)')
xlabel('Normalized Pixel Intensity')
title('Z')
xlim([0 1])
ylim([-7 7])
...
function plotStaticMicrospheres_FS
h(1) = figure('Color','White','Name','Extended Data Figure 2e','NumberTitle','off');
load('250411_005.mat')
subplot(2,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'Color',[.1 .62 .47])
axis([0 5 -1 1])
xlabel('Time (s)')
ylabel('Microsphere Shift (\mum)')
subplot(2,1,2)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,2),'Color',[.46 .44 .7])
axis([0 5 -1 1])
xlabel('Time (s)')
ylabel('Microsphere Shift (\mum)')
end
...
function plotStaticPaper_FS
h(1) = figure('Color','White','Name','Extended Data Figure 2g','NumberTitle','off');
load('191104_001.mat')
subplot(2,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'Color',[.1 .62 .47])
axis([0 5 -1 1])
xlabel('Time (s)')
ylabel('Paper Shift (\mum)')
subplot(2,1,2)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,2),'Color',[.46 .44 .7])
axis([0 5 -1 1])
xlabel('Time (s)')
...
if contains(figureTitle,'Supplementary Figure')
    h(6) = figure('Color','White','Name','Extended Data Figure 5d_2','NumberTitle','off');
    subplot(4,1,1)
    plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
    hold on
    plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
    ...
    h(6) = figure('Color','White','Name','Supplementary Figure 8d_3','NumberTitle','off');
    subplot(4,1,1)
    plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
    hold on
    plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
stationaryData.targetPosition(:,2) = stationaryData.targetPosition(:,2)-mean(stationaryData.targetPosition(2480:2530,2));
movementData.secondsPerFrame = movementData.secondsPerFrame/2;
h(6) = figure('Color','White','Name','Extended Data Figure 5e_1','NumberTitle','off');
subplot(4,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
hold on
plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
h(6) = figure('Color','White','Name','Extended Data Figure 5e_2','NumberTitle','off');
subplot(4,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
hold on
plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
h(6) = figure('Color','White','Name','Extended Data Figure 5e_3','NumberTitle','off');
subplot(4,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'g')
hold on
plot([1:size(stationaryData.targetPosition,1)]*movementData.secondsPerFrame,stationaryData.targetPosition(:,1),'m')
...
movementData.targetPosition(:,2) = movementData.targetPosition(:,2)*-1;
h(6) = figure('Color','White','Name','Extended Data Figure 3a','NumberTitle','off');
subplot(3,1,1)
plot([1:size(movementData.targetPosition,1)]*movementData.secondsPerFrame,movementData.targetPosition(:,1),'Color',[.1 .62 .47])
% title(['Figure 1e' 10 '\fontsize{20pt}\bf{Position of Brain and Skull}'])
xlabel('Time (s)')
...
h(6) = figure('Color','White','Name','Supplementary Figure 5b','NumberTitle','off');
subplot(1,4,1:3)
...
plot(plotLineX,plotLineY,'Color',[.5 0 .5])
xlim([0 150])
ylim([-0.1 1])
...
h(6) = figure('Color','White','Name','Supplementary Figure 3a','NumberTitle','off');
% subplot(2,3,1)
...
h(6) = figure('Color','White','Name','Supplementary Figure 3b','NumberTitle','off');
% subplot(2,3,2)
...
h(6) = figure('Color','White','Name','Supplementary Figure 3c','NumberTitle','off');
% subplot(2,3,3)
...
h(1) = figure('Color','White','Name','Supplementary Figure 2a','NumberTitle','off');
% subplot(2,2,1)
...
set(f,'facea',[.2]);
for n = 1:size(xCorrXLoc,1)
    plot(timeVecX,xCorrXLoc(n,:),'Color',[.1 .62 .47 0.1])
end
peak = max(meanXLoc);
...
for n = 1:size(xCorrYLoc,1)
    plot(timeVecY,xCorrYLoc(n,:),'Color',[.46 .44 .7 0.1])
end
peak = max(meanYLoc);
...
h(1) = figure('Color','White','Name','Supplementary Figure 2c','NumberTitle','off');
% subplot(2,2,3)
...
for n = 1:size(xCorrXEMG,1)
    plot(timeVecX,xCorrXEMG(n,:),'Color',[.1 .62 .47 0.1])
end
peak = max(meanXEMG);
...
h(1) = figure('Color','White','Name','Supplementary Figure 2d','NumberTitle','off');
% subplot(2,2,4)
...
for n = 1:size(xCorrYEMG,1)
    plot(timeVecY,xCorrYEMG(n,:),'Color',[.46 .44 .7 0.1])
end
peak = max(meanYEMG);
