...
This same file can be used to generate Suppl. Sim. Fig. 16 provided the values of the
permeability of the brain are set to those indicated in Suppl. Sim. Fig. 16.
...
The files main_test.mph, suppl_test_1.mph, and suppl_test_2.mph in this repository were created and run in COMSOL Multiphysics v6.1. The file main_test_mesh_sensitivity_study.mph was created and run with COMSOL Multiphysics v6.2. 
